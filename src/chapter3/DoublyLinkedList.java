...
public class DoublyLinkedList<E> {
	...
	public static void main(String[] args) {
		DoublyLinkedList<Integer> dl = getSampleDLL();
		System.out.println();
	...
	public static DoublyLinkedList<Integer> getSampleDLL() {
	...
	public static DoublyLinkedList<Integer> getSortedDLL() {
		DoublyLinkedList<Integer> dl = new DoublyLinkedList<>();
		dl.insertInDLinkList(3, 0);
		dl.insertInDLinkList(4, 1);
		dl.insertInDLinkList(5, 2);
		dl.insertInDLinkList(6, 3);
		dl.insertInDLinkList(9, 4);
		dl.insertInDLinkList(11, 5);
		return dl;
	}
